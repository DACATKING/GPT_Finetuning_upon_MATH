...
def create_fine_tuning_job(training_file_id, model="gpt-3.5-turbo", suffix="GPT4_MATH"):
...
if __name__ == "__main__":
    ...
    #fine_tuning_job_id = create_fine_tuning_job(training_file_id, model="gpt-3.5-turbo", suffix="GPT3.5_MATH")
